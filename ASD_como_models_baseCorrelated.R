...
# for ( i in 10 ) {
	...
	# print( output )
# }
# save( output, file="misDx_famh2_rg3_addMisDx_01to11.RData")


#Plot baseline COMO model
plot.0 <- plot.profiles.como.bnw( g.value.0, p.value.0,"ASD_Model0.bnw.pdf", 
...
plot.1a <- plot.profiles.como.bnw( g.value.0, p.value.1a, "ASD_Model1a_flip.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.1b <- plot.profiles.como.bnw( g.value.0, p.value.1b, "ASD_Model1b_flip.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.1c <- plot.profiles.como.bnw( g.value.0, p.value.1c, "ASD_Model1c_flip.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.1a <- plot.profiles.como.bnw( g.value.0, p.value.1a, "ASD_Model1a_add.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.1b <- plot.profiles.como.bnw( g.value.0, p.value.1b, "ASD_Model1b_add.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.1c <- plot.profiles.como.bnw( g.value.0, p.value.1c, "ASD_Model1c_add.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.2a <- plot.profiles.como.bnw( g.value.0, p.value.2a, "ASD_Model2a.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.2b <- plot.profiles.como.bnw( g.value.0, p.value.2b, "ASD_Model2b.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.2c <- plot.profiles.como.bnw( g.value.0, p.value.2c, "ASD_Model2c.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.2d <- plot.profiles.como.bnw( g.value.0, p.value.2d, "ASD_Model2d.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.3a <- plot.profiles.como.bnw( g.value.0, p.value.3a, "ASD_Model3a.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.3b <- plot.profiles.como.bnw( g.value.0, p.value.3b, "ASD_Model3b.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.3c <- plot.profiles.como.bnw( g.value.0, p.value.3c, "ASD_Model3c.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.4a <- plot.profiles.como.bnw( g.value.0, p.value.4a, "ASD_Model4a.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
...
plot.4b <- plot.profiles.como.bnw( g.value.0, p.value.4b, "ASD_Model4b.bnw.pdf", 
									traits.txt=traits, legend.txt=legend.txt )
