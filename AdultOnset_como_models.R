...
#Plot baseline
plot.0 <- plot.profiles.age.bnw( g.value.0, p.value.0,"AdultOnset_Model0.bnw.pdf", traits )
...
plot.1a <- plot.profiles.age.bnw( g.value.0, p.value.1a,"AdultOnset_Model1a.bnw.pdf", traits )
...
plot.1b <- plot.profiles.age.bnw( g.value.0, p.value.1b,"AdultOnset_Model1b.bnw.pdf", traits )
...
plot.2 <- plot.profiles.age.bnw( g.value.0, p.value.2,"AdultOnset_Model2.bnw.pdf", traits )
...
plot.3 <- plot.profiles.age.bnw( g.value.0, p.value.3,"AdultOnset_Model3.bnw.pdf", traits )
...
plot.4 <- plot.profiles.age.bnw( g.value.0, p.value.4,"AdultOnset_Model4.bnw.pdf", traits )
